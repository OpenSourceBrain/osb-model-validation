...
try:
    ...
    print(
        "Note: this file should be run using 'nC.bat -python XXX.py' or 'nC.sh -python XXX.py'"
    )
    print(
        "which use Jython (and so can access the Java classes in nC), as opposed to standard C based Python"
    )
